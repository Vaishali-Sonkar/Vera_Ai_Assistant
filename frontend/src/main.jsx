...
function Header() {
  return <header><div className="header-actions"><a className="resume-download" href="/assets/Vaishali_Sonkar_Resume.pdf" download="Vaishali_Sonkar_Resume.pdf" aria-label="Download Vaishali's resume" title="Download resume"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M11 3h2v10.2l3.6-3.6 1.4 1.4-6 6-6-6 1.4-1.4 3.6 3.6V3ZM5 19h14v2H5v-2Z"/></svg><span>Resume</span></a><a className="social-link" href={SOCIAL_LINKS.linkedin} target="_blank" rel="noopener noreferrer" aria-label="Open Vaishali's LinkedIn profile" title="LinkedIn"><SocialIcon type="linkedin"/></a><a className="social-link" href={SOCIAL_LINKS.github} target="_blank" rel="noopener noreferrer" aria-label="Open Vaishali's GitHub profile" title="GitHub"><SocialIcon type="github"/></a><span className="header-divider" aria-hidden="true"/><div className="mini-avatar">V</div></div></header>
}
